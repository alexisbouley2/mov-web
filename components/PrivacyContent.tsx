        ...
        <div className="prose prose-invert max-w-none">
          ...
          >
            ...
            <div className="grid gap-2 text-sm">
              <a href="#infocollect" className="text-blue-400 hover:text-blue-300 transition-colors py-1">1. What Information Do We Collect?</a>
              <a href="#infouse" className="text-blue-400 hover:text-blue-300 transition-colors py-1">2. How Do We Process Your Information?</a>
              <a href="#legalbases" className="text-blue-400 hover:text-blue-300 transition-colors py-1">3. What Legal Bases Do We Rely On?</a>
              <a href="#whoshare" className="text-blue-400 hover:text-blue-300 transition-colors py-1">4. When And With Whom Do We Share?</a>
              <a href="#ai" className="text-blue-400 hover:text-blue-300 transition-colors py-1">5. Do We Offer AI-Based Products?</a>
              <a href="#inforetain" className="text-blue-400 hover:text-blue-300 transition-colors py-1">6. How Long Do We Keep Your Information?</a>
              <a href="#infosafe" className="text-blue-400 hover:text-blue-300 transition-colors py-1">7. How Do We Keep Your Information Safe?</a>
              <a href="#privacyrights" className="text-blue-400 hover:text-blue-300 transition-colors py-1">8. What Are Your Privacy Rights?</a>
              <a href="#DNT" className="text-blue-400 hover:text-blue-300 transition-colors py-1">9. Controls For Do-Not-Track Features</a>
              <a href="#uslaws" className="text-blue-400 hover:text-blue-300 transition-colors py-1">10. Do US Residents Have Specific Rights?</a>
              <a href="#otherlaws" className="text-blue-400 hover:text-blue-300 transition-colors py-1">11. Do Other Regions Have Specific Rights?</a>
              <a href="#policyupdates" className="text-blue-400 hover:text-blue-300 transition-colors py-1">12. Do We Make Updates To This Notice?</a>
              <a href="#contact" className="text-blue-400 hover:text-blue-300 transition-colors py-1">13. How Can You Contact Us?</a>
              <a href="#request" className="text-blue-400 hover:text-blue-300 transition-colors py-1">14. How Can You Review, Update, Or Delete Data?</a>
            </div>
          </motion.section>
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <div>
                <h3 className="text-lg font-medium text-white mb-3">Application Data</h3>
                <p className="text-gray-300 leading-relaxed mb-4">
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <div className="bg-gray-900/30 border border-gray-800 rounded-lg p-6">
                <h3 className="font-medium text-white mb-3">Performance of a Contract</h3>
                <p className="text-gray-300 text-sm leading-relaxed">
              ...
              <div className="bg-gray-900/30 border border-gray-800 rounded-lg p-6">
                <h3 className="font-medium text-white mb-3">Legitimate Interests</h3>
                <p className="text-gray-300 text-sm leading-relaxed">
                  We may process your information when we believe it is reasonably necessary to achieve our legitimate business interests and those interests do not outweigh your fundamental rights and freedoms.
                </p>
              </div>
            </div>
          </motion.section>
          ...
          >
            ...
            <div className="space-y-4">
              <div className="bg-gray-900/30 border border-gray-800 rounded-lg p-6">
                <h3 className="font-medium text-white mb-3">Vendors, Consultants, and Other Third-Party Service Providers</h3>
                <p className="text-gray-300 text-sm leading-relaxed">
              ...
              <div className="bg-gray-900/30 border border-gray-800 rounded-lg p-6">
                <h3 className="font-medium text-white mb-3">Business Transfers</h3>
                <p className="text-gray-300 text-sm leading-relaxed">
          ...
          >
            ...
            <p className="text-gray-300 leading-relaxed mb-6">
              If you are a resident of California, Colorado, Connecticut, Utah, or Virginia, you are entitled to specific rights under applicable US state laws.
            </p>
            
            <div className="space-y-4">
              <div className="bg-gray-900/30 border border-gray-800 rounded-lg p-6">
                <h3 className="font-medium text-white mb-3">California Residents</h3>
                <p className="text-gray-300 text-sm leading-relaxed">
                  California Civil Code Section 1798.83, also known as the "Shine The Light" law, permits our users who are California residents to request and obtain from us, once a year and free of charge, information about the personal information (if any) we disclosed to third parties for direct marketing purposes.
                </p>
              </div>

              <div className="bg-gray-900/30 border border-gray-800 rounded-lg p-6">
                <h3 className="font-medium text-white mb-3">Other State Residents</h3>
                <p className="text-gray-300 text-sm leading-relaxed">
                  Residents of Colorado, Connecticut, Utah, and Virginia have similar rights under their respective state laws, including the right to access, correct, delete, and port their personal information.
                </p>
              </div>
            </div>
          </motion.section>
          ...
          >
            ...
            <p className="text-gray-300 leading-relaxed mb-6">
              If you are located in certain regions, you may have specific rights regarding your personal information.
            </p>
            
            <div className="space-y-4">
              <div className="bg-gray-900/30 border border-gray-800 rounded-lg p-6">
                <h3 className="font-medium text-white mb-3">European Economic Area (EEA), UK, and Switzerland</h3>
                <p className="text-gray-300 text-sm leading-relaxed">
                  If you are located in the EEA, UK, or Switzerland, you have the right to access, rectify, or erase your personal data, restrict processing, data portability, and object to processing. You also have the right to lodge a complaint with your local data protection authority.
                </p>
              </div>
              ...
              <div className="bg-gray-900/30 border border-gray-800 rounded-lg p-6">
                ...
                <p className="text-gray-300 text-sm leading-relaxed">
                  Canadian residents have the right to access, correct, or delete their personal information, and to withdraw consent for processing. You may also file a complaint with the Office of the Privacy Commissioner of Canada.
                </p>
              </div>
            </div>
          </motion.section>
          ...
          >
            ...
            <div className="bg-gray-900/30 border border-gray-800 rounded-lg p-6">
              <p className="text-gray-300 text-sm leading-relaxed">
                We encourage you to review this Privacy Notice frequently to be informed of how we are protecting your information. If we make material changes to this Privacy Notice, we may notify you either by prominently posting a notice of such changes or by directly sending you a notification.
              </p>
            </div>
          </motion.section>
          ...
          >
            ...
            <p className="text-gray-300 leading-relaxed mb-6">
              If you have questions or comments about this notice, you may contact our Data Protection Officer (DPO) by email, phone, or post. For information about our terms of service, please see our{" "}
          ...
          >
            ...
            <div className="space-y-4">
              <div className="bg-gray-900/30 border border-gray-800 rounded-lg p-6">
                <h3 className="font-medium text-white mb-3">Data Access and Modification</h3>
                <p className="text-gray-300 text-sm leading-relaxed">
                  To request to review, update, or delete your personal information, please submit a request by contacting us at the email address provided in the contact section. We will respond to your request within 30 days.
                </p>
              </div>
              ...
              <div className="bg-gray-900/30 border border-gray-800 rounded-lg p-6">
                ...
                <p className="text-gray-300 text-sm leading-relaxed">
                  We may need to verify your identity before processing your request. We may request additional information to confirm your identity and ensure the security of your personal information.
                </p>
              </div>
            </div>
          </motion.section>
